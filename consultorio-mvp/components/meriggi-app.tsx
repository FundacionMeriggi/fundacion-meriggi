...
type StaffRole = "Administrador" | "Profesional" | "Secretaría";
...
const initialStore: Store = {
  staff: [
    { id: "st-1", name: "Ignacio Simari", email: "cai.simari.ignacio@gmail.com", username: "ignacio.simari", role: "Administrador", specialty: "Administrativo", license: "", color: "#f5bc26", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-2", name: "Cecilia Simari", email: "", username: "cecilia.simari", role: "Administrador", specialty: "Psicólogo", license: "", color: "#d99600", active: true, notifyNewAppointment: false, notifyDailyAgenda: false },
    { id: "st-3", name: "Flor Morbelli", email: "floor.morbelli@live.com", username: "flor.morbelli", role: "Secretaría", specialty: "Administrativo", license: "", color: "#767676", active: true, notifyNewAppointment: false, notifyDailyAgenda: true },
    { id: "st-4", name: "Marcela Alejandra Imar Navarro", email: "imarmarcela@hotmail.com", username: "marcela.imar", role: "Profesional", specialty: "Psicólogo · Coordinadora del grupo de parejas", license: "MN 75307", color: "#a86d00", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-5", name: "Milena Belén Castaño", email: "milena_belen@hotmail.com", username: "milena.castano", role: "Profesional", specialty: "Taller", license: "", color: "#876b45", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-6", name: "Carolina Rojo Álvarez", email: "crojo1986@gmail.com", username: "carolina.rojo", role: "Profesional", specialty: "Psicólogo", license: "", color: "#9b7700", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-7", name: "Alberto Cárdenas", email: "psialbertocardenas@gmail.com", username: "alberto.cardenas", role: "Profesional", specialty: "Psicólogo", license: "62155", color: "#705900", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-8", name: "Luis Alberto Pesce", email: "luisalbertopesce53@gmail.com", username: "luis.pesce", role: "Profesional", specialty: "Operador socioterapéutico", license: "", color: "#6d7255", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-9", name: "Alejandra Almirón", email: "alejandra.15.1972@gmail.com", username: "alejandra.almiron", role: "Profesional", specialty: "Operadora", license: "", color: "#8b653f", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
    { id: "st-10", name: "Sofía Bareille", email: "lic.bareillesofia@gmail.com", username: "sofia.bareille", role: "Profesional", specialty: "Psicólogo", license: "MN 82799", color: "#b18a00", active: true, notifyNewAppointment: true, notifyDailyAgenda: true },
  ],

  patients: [
    { id: "pa-1", firstName: "Malena", lastName: "Suárez", document: "41.223.119", birthDate: "2000-05-12", email: "malena.suarez@example.com", phone: "+54 9 11 5500-1101", responsibleName: "", responsiblePhone: "", coverage: "Particular", primaryProfessionalId: "st-4", consent: true, notes: "Prefiere contacto por correo electrónico." },
    { id: "pa-2", firstName: "Julián", lastName: "Paredes", document: "35.881.420", birthDate: "1990-09-08", email: "julian.paredes@example.com", phone: "+54 9 11 5500-1102", responsibleName: "", responsiblePhone: "", coverage: "OSDE 210", primaryProfessionalId: "st-8", consent: true, notes: "Seguimiento interdisciplinario." },
    { id: "pa-3", firstName: "Emilia", lastName: "Acosta", document: "49.104.880", birthDate: "2010-03-19", email: "familia.acosta@example.com", phone: "+54 9 11 5500-1103", responsibleName: "Paula Acosta", responsiblePhone: "+54 9 11 5511-2200", coverage: "Swiss Medical", primaryProfessionalId: "st-4", consent: true, notes: "Paciente menor de edad. Contactar a la persona responsable." },
    { id: "pa-4", firstName: "Bruno", lastName: "Fernández", document: "39.444.120", birthDate: "1995-12-01", email: "bruno.fernandez@example.com", phone: "+54 9 11 5500-1104", responsibleName: "", responsiblePhone: "", coverage: "Galeno", primaryProfessionalId: "st-5", consent: false, notes: "Consentimiento digital pendiente." },
  ],
  appointments: [
    { id: "ap-1", patientId: "pa-1", staffId: "st-4", date: todayISO, time: "09:00", duration: 50, service: "Psicoterapia individual", reason: "Sesión de seguimiento", modality: "Presencial", status: "Confirmado", notifyPatient: true, createdAt: "2026-07-26T12:00:00-03:00" },
    { id: "ap-2", patientId: "pa-3", staffId: "st-4", date: todayISO, time: "10:00", duration: 50, service: "Psicología infantojuvenil", reason: "Entrevista de seguimiento", modality: "Presencial", status: "Pendiente", notifyPatient: true, createdAt: "2026-07-25T14:00:00-03:00" },
    { id: "ap-3", patientId: "pa-2", staffId: "st-8", date: todayISO, time: "11:30", duration: 40, service: "Consulta psiquiátrica", reason: "Control de tratamiento", modality: "Videollamada", status: "En espera", notifyPatient: true, createdAt: "2026-07-23T15:00:00-03:00" },
    { id: "ap-4", patientId: "pa-4", staffId: "st-4", date: todayISO, time: "14:00", duration: 50, service: "Admisión", reason: "Primera entrevista", modality: "Presencial", status: "Pendiente", notifyPatient: false, createdAt: "2026-07-27T11:00:00-03:00" },
    { id: "ap-5", patientId: "pa-1", staffId: "st-4", date: "2026-07-30", time: "09:00", duration: 50, service: "Psicoterapia individual", reason: "Sesión de seguimiento", modality: "Presencial", status: "Confirmado", notifyPatient: true, createdAt: "2026-07-26T12:00:00-03:00" },
  ],
  clinicalEntries: [
    { id: "ce-1", patientId: "pa-1", staffId: "st-4", date: "2026-07-21", type: "Evolución", text: "Se trabajaron recursos para la regulación emocional y organización de rutinas. Continúa seguimiento semanal.", private: true },
    { id: "ce-2", patientId: "pa-2", staffId: "st-8", date: "2026-07-18", type: "Seguimiento interdisciplinario", text: "Se revisó evolución general y coordinación con el espacio de psicoterapia. Próximo control en cuatro semanas.", private: true },
    { id: "ce-3", patientId: "pa-3", staffId: "st-4", date: "2026-07-15", type: "Entrevista inicial", text: "Entrevista con persona responsable. Se acordaron objetivos iniciales y frecuencia de encuentros.", private: true },
  ],
  messages: [],
  settings: {
...
export function MeriggiApp() {
  ...
  function openNewAppointment() {
    setAppointmentDraft({ id: id("ap"), patientId: store.patients[0]?.id ?? "", staffId: activeStaff.find((member) => member.role !== "Secretaría")?.id ?? "", date: selectedDate, time: "09:00", duration: 50, service: "Psicoterapia individual", reason: "", modality: "Presencial", status: "Pendiente", notifyPatient: true, createdAt: new Date().toISOString() });
